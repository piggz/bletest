...
public:
    ...
    const QString UUID_INFO_SERIAL_NO = "{00002a25-0000-1000-8000-00805f9b34fb}";
    const QString UUID_INFO_HARDWARE_REV = "{00002a27-0000-1000-8000-00805f9b34fb}";
    const QString UUID_INFO_SOFTWARE_REV = "{00002a28-0000-1000-8000-00805f9b34fb}";
    const QString UUID_INFO_SYSTEM_ID = "{00002a23-0000-1000-8000-00805f9b34fb}";
    const QString UUID_INFO_PNP_ID = "{00002a50-0000-1000-8000-00805f9b34fb}";
